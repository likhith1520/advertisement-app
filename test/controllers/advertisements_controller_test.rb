...
class AdvertisementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create advertisement" do
    assert_difference('Advertisement.count') do
      post advertisements_url, params: { advertisement: { desc: @advertisement.desc, others: @advertisement.others, phone: @advertisement.phone, title: @advertisement.title } }
    end
  ...
  test "should update advertisement" do
    patch advertisement_url(@advertisement), params: { advertisement: { desc: @advertisement.desc, others: @advertisement.others, phone: @advertisement.phone, title: @advertisement.title } }
